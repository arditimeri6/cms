<div class="box-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="form-group">
                    {{ Form::label('language_slug', trans('labels.backend.menus.field.language'), ['class' => 'col-lg-4 col-md-4 col-sm-4 control-label required']) }}
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <select name="language_slug" id="" class="search-input-select form-control">
                            <option value=""></option>
                            @foreach (config('global_settings.languages') as $language)
                                <option value="{{$language['slug']}}" @if(isset($menu) && $menu->language_slug == $language['slug']) selected="selected" @endif>{{$language['name']}}</option>
                            @endforeach
                        </select>
