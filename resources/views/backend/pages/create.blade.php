        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('publish_datetime', null, ['class' => 'form-control datetimepicker1 box-size', 'placeholder' => trans('validation.attributes.backend.pages.publish'), 'required' => 'required', 'id' => 'datetimepicker1']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
