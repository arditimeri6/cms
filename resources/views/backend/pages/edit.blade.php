    ...
    {{ Form::model($page, ['route' => ['admin.pages.update', $page], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-role']) }}
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('page_slug', trans('validation.attributes.backend.pages.slug'), ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('page_slug', null, ['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.pages.slug'), 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->                

                <div class="form-group">
                    {{ Form::label('publish_datetime', trans('validation.attributes.backend.pages.publish'), ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('publish_datetime', \Carbon\Carbon::parse($page->publish_datetime)->format('m/d/Y h:i a'), ['class' => 'form-control datetimepicker1 box-size', 'placeholder' => trans('validation.attributes.backend.pages.publish'), 'required' => 'required', 'id' => 'datetimepicker1']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    {{ Form::label('template', trans('validation.attributes.backend.pages.template'), ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                        {{ Form::text('template', null, ['class' => 'form-control box-size', 'placeholder' => trans('validation.attributes.backend.pages.template')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->                
