...
class BlogsRepository extends BaseRepository
{
    ...
    public function getForDataTable()
    {
        ...
        return $this->query()
            ...
            ->leftjoin('blog_map_categories', 'blog_map_categories'.'.blog_id', '=', config('module.blogs.table').'.id')
            ->leftjoin(config('module.blog_categories.table'), config('module.blog_categories.table').'.id', '=', 'blog_map_categories'.'.category_id')
            ->select([
                config('module.blogs.table').'.id',
                config('module.blogs.table').".name->{$locale} as name",
                ...
                config('module.blog_categories.table').'.name as category',
            ]);
    }
