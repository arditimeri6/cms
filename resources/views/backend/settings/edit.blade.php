...
<div class="box box-info">
	...
	<div class="box-body setting-block">
		...
		<ul id="myTab" class="nav nav-tabs setting-tab-list" role="tablist">
			...
			<li role="presentation">
				<a href="#tab7" aria-controls="5" role="tab" data-toggle="tab">{{ trans('labels.backend.settings.google_map') }}</a>
			</li>
		</ul>
		...
		<div id="myTabContent" class="tab-content setting-tab">
			...
			<div role="tabpanel" class="tab-pane" id="tab7">
				<div class="form-group">
					{{ Form::label('google_map_latitude', trans('validation.attributes.backend.settings.google.map_latitude'), ['class' => 'col-lg-2
					control-label']) }}

					<div class="col-lg-10">
						{{ Form::text('google_map_latitude', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.settings.google.map_latitude'),
						'rows' => 2]) }}
					</div>
				</div>
				<div class="form-group">
					{{ Form::label('google_map_longitude', trans('validation.attributes.backend.settings.google.map_longitude'), ['class' => 'col-lg-2
					control-label']) }}

					<div class="col-lg-10">
						{{ Form::text('google_map_longitude', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.settings.google.map_longitude'),
						'rows' => 2]) }}
					</div>
				</div>
				<!--form control-->
