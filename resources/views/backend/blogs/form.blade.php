<div class="box-body">
    ...
    <div class="form-group">
        {{ Form::label('short_content', trans('validation.attributes.backend.blogs.short-content'), ['class' => 'col-lg-2 control-label']) }}

        <div class="col-lg-10 mce-box">
            {{ Form::textarea('short_content', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.blogs.short-content')]) }}
        </div><!--col-lg-10-->
    </div><!--form control-->
    ...
    <div class="form-group">
        {{ Form::label('tags', trans('validation.attributes.backend.blogs.tags'), ['class' => 'col-lg-2 control-label']) }}
...
@section("after-scripts")
    <script type="text/javascript">
        ...
        Backend.Blog.selectors.SlugUrl = "";
        Backend.Blog.init();
