...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'view-theme';
        $viewBackend->display_name = 'View Theme';
        $viewBackend->sort = 27;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-theme';
        $viewBackend->display_name = 'Create Theme';
        $viewBackend->sort = 28;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-theme';
        $viewBackend->display_name = 'Edit Theme';
        $viewBackend->sort = 29;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'delete-theme';
        $viewBackend->display_name = 'Delete Theme';
        $viewBackend->sort = 30;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'view-language';
        $viewBackend->display_name = 'View Language';
        $viewBackend->sort = 31;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'create-language';
        $viewBackend->display_name = 'Create Language';
        $viewBackend->sort = 32;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'edit-language';
        $viewBackend->display_name = 'Edit Language';
        $viewBackend->sort = 33;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $permission_model = config('access.permission');
        $viewBackend = new $permission_model();
        $viewBackend->name = 'delete-language';
        $viewBackend->display_name = 'Delete Language';
        $viewBackend->sort = 34;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
