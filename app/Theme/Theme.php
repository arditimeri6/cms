...
use App\Theme\Contracts\Theme as ThemeContract;
use App\Theme\Manifest;
...
class Theme implements ThemeContract
{
        ...
        Manifest $manifest)
    {
        ...
        $this->theme(config('global_settings.theme')['name']);
    ...
    public function all()
    {
        ...
        $path = base_path().DIRECTORY_SEPARATOR.Theme::getConfig('themeDir');
